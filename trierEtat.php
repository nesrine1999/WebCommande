...
$listeCommandes=$commandeC->triercommande() ; 
$listeCommandes2=$commandeC->triercommandeNom() ; 
$listeCommandes3=$commandeC->triercommandeCategorie() ; 
$listeCommandes4=$commandeC->triercommandePrix() ; 
$listeCommandes5=$commandeC->triercommandeEtat() ; 
$listeCommandes6=$commandeC->triercommandeUser() ; 
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus-circle"></i> </i>  Ajouter une commande</a></div>
          <!-- Content Row -->
          <div class="row">
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
                      ...
                      <tbody>
                                              <?php
                         foreach($listeCommandes5 as $row){
                         ?><tr>
                          ...
                          <th><?php echo $row ['user'] ; ?></th>
                            <td><a href="modifierCom.php?id=<?PHP echo $row['id']; ?>"><button style="background-color: transparent;border: 0px" title="Modifier" ><i class="fas fa-pen"></i></button></a></td>
                        </tr>
                          <?php 
