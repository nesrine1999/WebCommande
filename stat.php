<?php
$dbhandle =new mysqli('localhost','root','','snt');
echo $dbhandle->connect_error;

$query ="SELECT categorie, sum(prix) FROM commande group by categorie ";
...
<head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        {
          echo "['".$row['categorie']."',".$row['sum(prix)']."],";
          }
          ?>
        ]);

        var options = {
          title: 'categorie les plus vendues  ',
          is3D:true,
        };
